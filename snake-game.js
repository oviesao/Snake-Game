...
(function(){
    ...
    g.SnakeTile.prototype.render = function(i) {
        ...
        this.elem.style.width = this.w + 'px';
        this.elem.style.height = this.h + 'px';
        this.elem.style.backgroundColor = 'rgba(0, 240, 255, ' + this.alpha + ')';
        this.elem.style.boxShadow = '0 0 ' + this.blur + 'px rgba(0, 240, 255, 0.7)';
...
(function(){
    ...
    g.FoodTile.prototype.render = function() {
        ...
        this.elem.style.boxShadow = '0 0 ' + this.blur + 'px hsla(' + this.hue + ', 100%, 60%, 0.7)';
